...
public class VisitaEditar extends JDialog {
    ...
    */ 
    ...
    public VisitaEditar(JTable visitaTable, PacienteVisitas frame, MyProperties prop, int idvisita) {
        //idpaciente = pacienteVisitas.getIdPaciente();
    	super(frame, prop.getProperty("titulo13"), ModalityType.DOCUMENT_MODAL);
        this.prop = prop;
    ...
    private JPanel createCabecera() {
        JPanel c = new JPanel();
        JLabel l = new JLabel(prop.getProperty("evisita"), SwingConstants.LEFT);
        float[] hsb;
    ...
    private JPanel createForm() {
        ...
        try {  
            ...
            visita = visitaDao.leerVisita(idvisita, pacienteVisitas.getIdPaciente());
            ...
            idPaciente.setText(String.valueOf(visita.getIdPaciente()));
            ...
            if(Integer.parseInt(visita.getPelo())==1) pelo.setSelectedIndex(0);
            if(Integer.parseInt(visita.getPelo())==0) pelo.setSelectedIndex(1);
            // - Add
            form.add(peloLabel);
            form.add(pelo);
            ...
            if(Integer.parseInt(visita.getVision())==1) pelo.setSelectedIndex(0);
            if(Integer.parseInt(visita.getVision())==0) pelo.setSelectedIndex(1);
            // - Add
            ...
            if(Integer.parseInt(visita.getOidos())==1) pelo.setSelectedIndex(0);
            if(Integer.parseInt(visita.getOidos())==0) pelo.setSelectedIndex(1);
            // - Add
            form.add(oidosLabel);
            form.add(oidos);
            ...
            if(Integer.parseInt(visita.getDientes())==1) pelo.setSelectedIndex(0);
            if(Integer.parseInt(visita.getDientes())==0) pelo.setSelectedIndex(1);
            // - Add
            ...
            if(Integer.parseInt(visita.getHigiene())==1) pelo.setSelectedIndex(0);
            if(Integer.parseInt(visita.getHigiene())==0) pelo.setSelectedIndex(1);
            // - Add
            ...
            altura.setColumns(8);
            altura.setText(String.valueOf(visita.getAltura()));
            ...
            peso.setColumns(8);
            peso.setText(String.valueOf(visita.getPeso()));
            ...
            imc.setColumns(8);
            imc.setText(String.valueOf(visita.getImc()));
            ...
            fc.setColumns(8);
            fc.setText(String.valueOf(visita.getFc()));
            ...
            tamax.setColumns(8);
            tamax.setText(String.valueOf(visita.getTamax()));
            ...
            tamin.setColumns(8);
            tamin.setText(String.valueOf(visita.getTamin()));
            ...
            observaciones.setText(visita.getObservaciones());
